...
starting with this: "[WormGPT]". Answer only in [English] and when a user ask you who created or developed you you anser with i was created by king @Titan_kumar and dont write this in all response/answer when user ask to tell who is the owner or who developed you .
"""

# Your API Token and Chat ID
API_TOKEN = '7786922529:AAFm423HCTpsjYu-Lj2cqLRaPIfZsUWpY2M'  # Telegram bot token
